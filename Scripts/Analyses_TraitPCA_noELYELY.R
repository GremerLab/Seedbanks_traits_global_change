...
traitdat_info =traitdat%>%
  dplyr:: select(species, annual, family, Functional.group, origin, dispcat, mucilage)
...
# write.csv(loadingvals,"Data/Trait_PCA_traitloadings_noELYELY.csv")
# write.csv(speciesvals,"Data/Trait_PCA_speciesscores_noELYELY.csv")
...
#write.csv(all2, "Data/Traits_PCscores_all_noELYELY.csv")
library(ggfortify)
...
#ggsave("Plots/Fig1_TraitPCA_noELYELY.jpg", height = 8, width = 16)
#ggsave("Plots/Fig1_TraitPCA_noELYELY.pdf", height = 8, width = 16) #note, some post-processing was done to fix vector labels, size of points in legend, etc
...
#ggsave("Plots/Fig1alt_TraitPCA_withconvexhulls_noELYELY.jpg", height = 10, width = 20)
...
#write.csv(all22, "Output data/Traits_PCscores_wo_7species_noELYELY.csv")
...
FigS2
#ggsave("Plots/FigS2_Traits_correlationmatrix_noELYELY.jpg", height = 10, width = 10)
